...
namespace Architecture.Project.Tests.MessageBus.Publisher;

public class PublisherTests
{
    private readonly Mock<ILogger<global::Architecture.Project.SqsMessageBus.Publisher.Publisher>> _loggerMock = new();
    private readonly Mock<IAmazonSQS> _sqsClientMock = new();
    private readonly global::Architecture.Project.SqsMessageBus.Publisher.Publisher _publisher;
