...
using Architecture.Project.SqsMessageBus.Consumer;
using Architecture.Project.SqsMessageBus.Publisher;
using Microsoft.Extensions.Logging;
using Moq;

namespace Architecture.Project.Tests.MessageBus.Consumer;

public class ConsumerTests
{
    private readonly Mock<ILogger<global::Architecture.Project.SqsMessageBus.Consumer.Consumer>> _loggerMock = new();
    private readonly global::Architecture.Project.SqsMessageBus.Consumer.Consumer _consumer;
    ...
    public async Task ReceiveObjectAsync_ShouldCallSendAsync_WhenThrowExceptionAndErrorQueueName()
    {
        ...
        var onMessage = new Func<TestMessage, Task<Task?>>(_ => throw new Exception());
        var cancellationToken = new CancellationToken();
        var response = new ReceiveMessageResponse
        {
            Messages = new List<Message>
